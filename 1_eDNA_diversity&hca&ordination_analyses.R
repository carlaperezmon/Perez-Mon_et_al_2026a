...
#text and theme layout for ggplot representations
size_text_y=10
size_text_x=10
size_text_label=14
size_axis_labs=10
...
### LOAD ASVS ABUNDANCE TABLES, REPRESENTATIVE SEQUENCES AND TAXONOMY -------
...
# Polish taxonomic tables: split taxa levels, remove unknowns, rename etc -----
...
### REMOVE READS FROM CONTROLS AND CREATE RAREFIED COUNTS -----
...
for (i in 1:length(marker)){
  ...
  ##### save the negative controls counts
...
new=metadata$sample.id[metadata$source!='WHO-old'] # to detect differences between more recent acquired batches or old acquired batches in HCA analyses
...
#for all batches
outliers_16S=c('36060OR0008L01','32800OR0065L01','36060OR0060L01','36060OR0079L01')
outliers_18S=c("32800OR0041L01",'36060OR0003L01','36060OR0113L01',
               '36060OR0112L01','36060OR0115L01','36060OR0116L01','36060OR0139L01') # alternative to check the discriminating power of 18S, it is not good, likely because of excipients influence
...
#classification to groups created in the HCA analyses
...
for (i in 1:length(marker)) {
  ...
  #for representation of colors and shape in plot
  ...
  #calculation/visualization of pairwise distances for better decision about group assignment
...
### EXTRA NMDS for classification of W16 to groups 4 or 6 ######
...
for (i in 1:length(marker)) {
  ...
  ## PCAs comparing place of collection or tablet manufacturing date 
...
### OTHERS ###   
### general taxonomy tables (tables S5 and S6) ######
